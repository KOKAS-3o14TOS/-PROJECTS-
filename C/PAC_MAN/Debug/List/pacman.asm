...
_0x26:
	.DB  0xE,0x1D,0x1F,0x1F,0x1E,0x1F,0xE
_0x27:
...
; 0000 0064 CreateChar(closed, pacClosed);
	ST   -Y,R3
	LDI  R26,LOW(_pacClosed)
	LDI  R27,HIGH(_pacClosed)
	RCALL _CreateChar
; 0000 0065 CreateChar(open, pacOpen);
	ST   -Y,R6
	LDI  R26,LOW(_pacOpen)
	LDI  R27,HIGH(_pacOpen)
	RCALL _CreateChar
; 0000 0066 CreateChar(closedL, pacClosedL);
	ST   -Y,R5
	LDI  R26,LOW(_pacClosedL)
	LDI  R27,HIGH(_pacClosedL)
	RCALL _CreateChar
; 0000 0067 CreateChar(openL, pacOpenL);
	ST   -Y,R8
	LDI  R26,LOW(_pacOpenL)
	LDI  R27,HIGH(_pacOpenL)
	RCALL _CreateChar
; 0000 0068 
; 0000 0069 while (1)
_0x29:
